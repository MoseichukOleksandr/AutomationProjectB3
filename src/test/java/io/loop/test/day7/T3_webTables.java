...
public class T3_webTables extends TestBase {
    ...
    public void test_webTables () throws InterruptedException {
        ...
        Assert.assertEquals(actualFullName,expectedFullName, "Actual doesent match the expected");
        ...
        Assert.assertEquals(expectedUserName,actualUserName, "Actual User Name doesnt match expected");
        ...
        Assert.assertEquals(expectedPhoneNumber,actualPhoneNumber, "Actual Phone Number doesnt match expected");
        System.out.println("actualUserName = " + actualUserName);
