...
public class T2_explicit_wait {
    ...
    public void explicit_wait_test() {
        ...
        assertTrue(loopPracticeDynamicLoading7.doneMessage.isDisplayed(), "Element are not displ");
        assertTrue(loopPracticeDynamicLoading7.image.isDisplayed(),"Element is not disp");
    }
}
